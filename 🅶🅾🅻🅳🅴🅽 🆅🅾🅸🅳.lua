...
SN = gg.choice({
   ...
   "╭───────────────────────────────────|\n📂Gₒₗdₑₙ ᵥₒᵢD ᵢₙ ₘₐₑₗₛₜᵣₒₘ(ᴵⁿᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤ 🇪​\n╰───────────────────────────────────|",
   "╭───────────────────────────────────|\n📂Gₒₗdₑₙ ᵥₒᵢD☞ₘₐₑₗₛₜᵣₒₘ(ᴸᵒᵇᵇʸ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤ 🇳​\n╰───────────────────────────────────|",
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("35.20000076294F;350019.0F;349985.0F:261", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.refineNumber("35.20000076294F", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(1, nil, nil, nil, nil, nil, nil, nil, nil)
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("49.0F;350019.0F;349985.0F:205", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(1, nil, nil, nil, nil, nil, nil, nil, nil)
...
gg.setRanges(gg.REGION_C_ALLOC) 
gg.searchNumber("68.0F;350019.0F;349985.0F:265", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.refineNumber("68", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(4, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("99999999999999999999", gg.TYPE_FLOAT)

revert = gg.getResults(4, nil, nil, nil, nil, nil, nil, nil, nil)
local t = gg.getResults(4, nil, nil, nil, nil, nil, nil, nil, nil)
for i, v in ipairs(t) do
	if v.flags == gg.TYPE_FLOAT then
		v.value = "1.00000002e20"
		v.freeze = true
	end
end
gg.addListItems(t)
